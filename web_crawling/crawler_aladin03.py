...
best51 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[3]/a').click()
best101 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[4]/a').click()
best151 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[5]/a').click()
best201 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[6]/a').click()
best251 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[7]/a').click()
best301 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[8]/a').click()
best351 = driver.find_element(By.XPATH, '//*[@id="newbg_body"]/div[3]/ul/li[9]/a').click()
