...
print('-' * 40)
print(s.find('o')) # start to find from the front
print(s.rfind('o')) # start to find from the back
...
"""
print(message.count('기린'))

'''
- 특정 문자가 있는 인텍스나 번호 및 횟수는 관심 없고
 단수히 포함 여부만 빠르게 확인하고 싶다면 in 키워드를 사용합니다
'''
print('-' * 40)
